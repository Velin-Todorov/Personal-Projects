...
minus_button = Button(root, text='-', padx=50, command= subtract, font='Helvetica 15', width=5).grid(row=4, column=3)
divide_button = Button(root, text='/', padx=50, command= divide,font='Helvetica 15', width=5 ).grid(row=5, column=2)
multiply_button = Button(root, text='*', padx=50, command= multiply,font='Helvetica 15', width=5).grid(row=5, column=3)
